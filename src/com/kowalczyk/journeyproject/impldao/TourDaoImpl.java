...
public class TourDaoImpl extends BaseDaoImpl implements TourDao {
    ...
    public void insertTour(TourJourney tourJourney) {
        try {
            ...
            prStatement.setString(3, tourJourney.getDate());
            prStatement.setString(4, tourJourney.getHotel().getName());
            prStatement.setString(5, tourJourney.getAirport());
            prStatement.setInt(6, tourJourney.getPrice());
    ...
    public List<TourJourney> findAllTours() {
        ...
        try{
            ...
            while (resultSet.next()){
                ...
                tourJourneyList.add(new TourJourney(name, place, date, hotel, airport, price));
            }
        } catch (SQLException e) {
            e.printStackTrace();
            return null;
    ...
    public void deleteBoughtTourJourney(TourJourney tourJourney) {
        System.out.println(tourJourney.getPlace());
